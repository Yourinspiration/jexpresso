...
/**
 * An implementation for {@link SessionStore} that stores de.yourinspiration.jexpresso.session data in a
 * MongoDB database.
 *
 * @author Marcel Härle
 */
public class MongoStore implements SessionStore {
     ...
     * @param collection the name of the collection to be used for storing the de.yourinspiration.jexpresso.session
     *                   data
     */
